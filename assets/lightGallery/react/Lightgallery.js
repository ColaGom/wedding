(function (global, factory) {
    ...
    (global.Lightgallery = factory(global.React));
    ...
    ***************************************************************************** */
    ...
    var LG = function (_a) {
        ...
        React.useEffect(function () {
            var lightGallery = new LightGallery($lg.current, restProps);
            return function cleanup() {
                lightGallery.destroy();
            };
        }, []);
        return (React.createElement("div", { ref: $lg, className: className }, children));
    };
