...
var LightGallery = /** @class */ (function () {
    function LightGallery(element, options) {
        ...
        this.settings = __assign(__assign({}, lg_settings_1.lightGallerySettings), options);
    ...
    LightGallery.prototype.refreshOnResize = function () {
        if (this.lgOpened) {
            ...
            this.currentImageSize = lg_utils_1.default.getSize(this.items[this.index], this.$lgContent, top_1 + bottom, videoInfo && this.settings.videoMaxSize);
            if (videoInfo) {
    ...
    LightGallery.prototype.openGallery = function (index, element) {
        ...
        if (this.zoomFromOrigin && element) {
            this.currentImageSize = lg_utils_1.default.getSize(element, this.$lgContent, top + bottom, this.galleryItems[this.index].__slideVideoInfo &&
                this.settings.videoMaxSize);
            transform = lg_utils_1.default.getTransform(element, this.$lgContent, top, bottom, this.currentImageSize);
        }
    ...
    LightGallery.prototype.loadContent = function (index, rec) {
        ...
        if (!$currentSlide.hasClass('lg-loaded')) {
            if (videoInfo) {
                ...
                var videoSize = lg_utils_1.default.getSize(this.items[index], this.$lgContent, top_2 + bottom, videoInfo && this.settings.videoMaxSize);
                lgVideoStyle = this.getVideoContStyle(videoSize);
            }
            if (iframe) {
                var markup = lg_utils_1.default.getIframeMarkup(src, this.settings.iframeWidth, this.settings.iframeHeight, currentGalleryItem.iframeTitle);
    ...
    LightGallery.prototype.slide = function (index, fromTouch, fromThumb, direction) {
        ...
        if (!this.lgBusy) {
            ...
            if (videoInfo) {
                ...
                var videoSize = lg_utils_1.default.getSize(this.items[index], this.$lgContent, top_3 + bottom, videoInfo && this.settings.videoMaxSize);
    ...
    LightGallery.prototype.closeGallery = function (force) {
        ...
        if (this.zoomFromOrigin && currentItem) {
            ...
            var imageSize = lg_utils_1.default.getSize(currentItem, this.$lgContent, top_4 + bottom, this.galleryItems[this.index].__slideVideoInfo &&
                this.settings.videoMaxSize);
            transform = lg_utils_1.default.getTransform(currentItem, this.$lgContent, top_4, bottom, imageSize);
        }
        if (this.zoomFromOrigin && transform) {
