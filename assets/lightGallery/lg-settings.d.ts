...
declare type LightGalleryCoreMobileSettings = Exclude<LightGallerySettings, 'mobileSettings'>;
export interface MobileSettings extends LightGalleryCoreMobileSettings, ZoomSettings, ThumbnailsSettings, VideoSettings, AutoplaySettings, CommentSettings, FullscreenSettings, HashSettings, PagerSettings, RotateSettings, ShareSettings {
}
...
export declare const lightGallerySettings: LightGallerySettings;
export {};
